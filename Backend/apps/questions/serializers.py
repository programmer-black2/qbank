...
#     """سریالایزر کامل برای جزئیات سوال"""
...
#             'choices', 'answer', 'media_items'
#         ]
#         read_only_fields = fields


# class QuestionCreateUpdateSerializer(serializers.ModelSerializer):
#     """سریالایزر برای ایجاد و ویرایش سوال"""
...
#         answer = self.initial_data.get('answer', None)
...
#         elif question.question_type == 'descriptive' and answer_data:
...
#             # اگر سوال از descriptive به mcq تغییر کرده، پاسخ تشریحی حذف شود
#             if hasattr(instance, 'answer'):
#                 instance.answer.delete()

#         elif instance.question_type == 'descriptive':
#             # اگر سوال از mcq به descriptive تغییر کرده، گزینه‌ها حذف شوند
#             instance.choices.all().delete()

#             if answer_data is not None:
#                 if hasattr(instance, 'answer'):
#                     for attr, value in answer_data.items():
#                         setattr(instance.answer, attr, value)
